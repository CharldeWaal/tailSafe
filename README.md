...
```json
{
  "compilerOptions": {
    ...
    "paths": {
      "tailsafe/provider": ["./.tailsafe/ProviderWrapper.tsx"]
    }
  },
  "include": [
    "src/**/*",
...
> **Important:** The `.tailsafe/**/*.d.ts` include is required for TypeScript to recognize your custom alias types generated by `npx tailsafe`.

### After Setup

1. Run `npx tailsafe` to generate type definitions and provider components
2. **Restart your TypeScript server** to pick up the new types:
   - **VS Code**: `Cmd/Ctrl + Shift + P` → "TypeScript: Restart TS Server"
   - **Or restart your dev server**

> **💡 Tip:** If you're still getting type errors for custom aliases after running `npx tailsafe`, make sure you've restarted your TypeScript server!
