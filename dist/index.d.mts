...
/**
 * FlexRowAliasProps alias
 */
interface FlexRowAliasProps {
  'flex-row'?: boolean;
}

/**
 * FlexColAliasProps alias
 */
interface FlexColAliasProps {
  'flex-col'?: boolean;
}
...
type GeneratedTailSafe = TailSafe$1 extends infer T ? T extends Record<string, any> ? T : {} : {};
interface TailSafe extends TailSafeBase, GeneratedTailSafe {
}
