...
var TailSafeContext = createContext({});
var TailSafeProvider = ({
  ...
  return /* @__PURE__ */ jsx(TailSafeContext.Provider, { value: contextValue, children });
};
...
var AutoTailSafeProvider = (_a) => {
  ...
  const finalAliases = useMemo(() => __spreadValues(__spreadValues({}, tailSafeConfig2.aliases), userAliases), [userAliases]);
  if (props.debug) {
  ...
  return /* @__PURE__ */ jsx2(TailSafeProvider, __spreadProps(__spreadValues({}, props), { userAliases: finalAliases, children }));
};

// src/hooks/useTailSafe/useTailSafe.ts
var useTailSafe = () => useContext(TailSafeContext);
...
function withTailSafe(Component) {
  const Wrapped = React4.forwardRef((props, ref) => {
    ...
    return /* @__PURE__ */ jsx4(Component, __spreadProps(__spreadValues({}, transformedProps), { ref }));
  });
